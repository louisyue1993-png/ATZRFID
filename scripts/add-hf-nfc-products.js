...
const hfNfcProducts = [
  {
    ...
    features: ['PCB embedded design', 'High temperature resistant', 'Waterproof', 'Durable construction'],
    applications: ['Industrial equipment', 'Embedded systems', 'Asset tracking', 'Access control'],
  ...
  },
  {
    ...
    features: ['IP67 waterproof', 'Impact resistant', 'UV resistant', 'Multiple mounting options'],
    applications: ['Outdoor tracking', 'Industrial assets', 'Vehicle tracking', 'Supply chain'],
  ...
  },
  {
    ...
    features: ['Ultra-thin design', 'Strong adhesive', 'Smartphone compatible', 'Printable surface'],
    applications: ['Smart posters', 'Business cards', 'Product packaging', 'Mobile payments'],
